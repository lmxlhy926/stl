...
service_mdns(const char* hostname, const char* service_name, int service_port) {
	...
	service_t service = {0};
	service.service = service_string;                           //_test-mdns._tcp.local.
	service.hostname = hostname_string;                         //dummy-host
	service.service_instance = service_instance_string;         //<hostname>.<_service-name>._tcp.local.
	service.hostname_qualified = hostname_qualified_string;     //<hostname>.local.
