...
#ifndef SITEMANAGERSERVICE_MDNS_H
#define SITEMANAGERSERVICE_MDNS_H
...
static const uint8_t mdns_services_query[] = {
        ...
        // No answer, authority or additional RRs
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        // changhong.edgeai.site_query
        0x09, 'c', 'h', 'a', 'n', 'g', 'h', 'o', 'n', 'g', 0x06, 'e', 'd', 'g', 'e', 'a', 'i',
        0x0a, 's', 'i', 't', 'e', '_', 'q', 'u', 'e', 'r', 'y', 0x00,
        // PTR record
        0x00, MDNS_RECORDTYPE_PTR,
        // QU (unicast response) and class IN
        0x80, MDNS_CLASS_IN};
...
//  or <0 if error.
int mdns_discovery_answer(int sock, const void* address, size_t address_size, void* buffer,
...
void* mdns_string_make_with_ref(void* data, size_t capacity, const char* name, size_t length,
                                size_t ref_offset);
...
#endif //SITEMANAGERSERVICE_MDNS_H
